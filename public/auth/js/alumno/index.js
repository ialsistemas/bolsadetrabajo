...
function mostrarTodoxAño() {
    $dni_apellido.val(""); //para que se limpie antes
    $("#btn_mostrar").attr("mostrar", "");
    $dataTableAlumno.ajax.reload();
    ...
    $dataTableAlumno = $tableS.DataTable({
        ...
        ajax: {
            ...
            data: function (s) {
                ...
                if ($dni_apellido.val() != "") {
                    s.dni_apellido = $dni_apellido.val();
                }
        ...
        columns: [
            ...
            // },
            {
                ...
                data: "egresado",
                render: function (data) {
                    return data == TIPOS_ALUMNOS.ALUMNO
                        ? "ESTUDIANTE"
                        : data == TIPOS_ALUMNOS.EGRESADO
                        ? "EGRESADO"
                        : data == TIPOS_ALUMNOS.TITULADO
                        ? "TITULADO"
                        : "-";
                },
            },
            ...
            },
            {
                ...
                render: function (data) {
                    ...
                    if (
                        ...
                        data.educaciones.length < 1
                    ) {
                        /**|| data.hoja_de_vida === null || data.hoja_de_vida === ""**/
