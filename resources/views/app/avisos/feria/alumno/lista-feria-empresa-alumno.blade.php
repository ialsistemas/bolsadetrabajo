            ...
            <div class="row">
                ...
                <div class="col-md-7 not-padding">
                    <div class="filter p-4">
                        ...
                        <div class="row">
                            @foreach ($avisoEmpresaData as $avisoEmpresa)
                                <div class="col-lg-2 col-12">
                                    <a href="{{ route('alumno.ecenario-feria-aviso-alumno-empresa', $avisoEmpresa->linkEmpresa) }}"><img src="{{ asset('app/img/logo_empresas/'.$avisoEmpresa->logoEmpresa) }}" alt="{{ $avisoEmpresa->nameEmpresa }}"></a>
                                </div>
                            @endforeach
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        const imgLogoBaseUrl = "{{ asset('app/img/feria/logo') }}/";
