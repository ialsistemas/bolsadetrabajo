                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-input" value="{{ $Empresa->razon_social }}"
                                        name="razon_social" id="razon_social" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-input" value="{{ $Empresa->nombre_comercial }}"
                                        name="nombre_comercial" id="nombre_comercial" readonly>
                                </div>
                                <div class="col-md-6">
                                    <label for="ruc">RUC</label>
                                    <input type="text" class="form-input" value="{{ $Empresa->ruc }}" name="ruc"
                                        id="ruc" readonly placeholder="RUC" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <label for="distrito">Distrito</label>
                                    <input type="text" class="form-input" value="{{ $Empresa->distritos->nombre }}"
                                        name="distrito" id="distrito" readonly>
                                </div>
                                <div class="col-md-6">
                                    <label for="ciudad">Ciudad</label>
                                    <input type="text" class="form-input" value="{{ $Empresa->provincias->nombre }}"
                                        name="ciudad" id="ciudad" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-input" value="{{ $Empresa->direccion }}"
                                        name="direccion" id="direccion" placeholder="Dirección" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-input" value="{{ $Empresa->telefono }}"
                                        name="telefono" id="telefono" readonly required>
                                </div>
                                <div class="col-md-6">
                                    <label for="pagina_web">Página web</label>
                                    <input type="text" class="form-input" value="{{ $Empresa->pagina_web }}"
                                        name="pagina_web" id="pagina_web" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <label for="pagina_web">Correo electrónico</label>
                                    <input type="email" class="form-input" value="{{ $Empresa->email }}" name="email"
                                        id="email" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
