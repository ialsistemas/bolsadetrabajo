<div id="modalMantenimientoModalidad" class="modal modal-fill fade" data-backdrop="false" tabindex="-1">
    <div class="modal-dialog modal-sm">
        <form enctype="multipart/form-data" action="{{ route('auth.modalidad.store') }}" id="registroModalidad" method="POST"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ $Entity != null ? "Modificar" : " Registrar" }} Modalidad</h5>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-bold btn-pure btn-primary">{{ $Entity != null ? "Modificar" : " Registrar" }} Modalidad</button>
                </div>
            </div>
        </form>
    </div>
...
<script type="text/javascript" src="{{ asset('auth/js/modalidad/_Mantenimiento.min.js') }}"></script>
